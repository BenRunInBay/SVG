...
<template>
    <h1>Technique 2 media query</h1>
    <div class="two">
        <ul>
            <li>Organize elements using &lt;g&gt; group elements and assign each a unique ID</li>
            <li>Use media queries to show or hide grouped elements based on screen size</li>
            <li class="demo">This example uses the SVG inline which allows for full access to DOM and CSS</li>
        </ul>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 162 162" class="outline">
            <g id="basecircle">
                <path
                    fill="#0D1121"
                    d="M81.33,162.663c-21.723,0-42.149-8.461-57.508-23.82C8.459,123.479,0,103.056,0,81.331
                ...
                <path
                    d="M81.334,150.987c-38.406,0-69.653-31.248-69.653-69.657c0-38.407,31.247-69.652,69.653-69.652
			...
			C150.492,43.197,119.468,12.175,81.334,12.175z"
                ...
                <path
                    d="M81.334,157.21c-41.837,0-75.877-34.039-75.877-75.879c0-41.838,34.04-75.875,75.877-75.875
			...
			C150.492,43.197,119.468,12.175,81.334,12.175z"
                ...
                <path
                    fill="#0D1121"
                    d="M84.435,81.562c-0.021,0.374-0.119,0.786-0.286,1.133c-0.173,0.354-0.414,0.667-0.703,0.919
			...
			c0.85-0.017,1.699,0.363,2.252,0.99c0.556,0.624,0.842,1.455,0.8,2.252V81.562z"
                ...
                <path
                    fill="#0D1121"
                    d="M74.771,87.113c-0.714-0.795-1.346-1.831-1.708-2.874c-0.371-1.063-0.512-2.184-0.441-3.275
            ...
            <g id="hourhand">
                <path
                    fill="#0D1121"
                    d="M86.583,52.067c-0.012-1.964-2.585-2.81-2.585-2.81l-0.012-1.939c0,0,0.745-0.124,0.819-0.857
                ...
                <path
                    fill="#0D1121"
                    d="M81.413,55.959c0,0,0.076,0.415,0.174,1.141c0.097,0.726,0.222,1.761,0.324,3.005
            ...
            <g id="minutehand">
                <path
                    fill="#0D1121"
                    d="M113.439,54.993c1.048-1.068,0.111-2.904,0.111-2.904l1.033-1.055c0,0,0.471,0.333,0.902-0.022
                ...
                <path
                    fill="#0D1121"
                    d="M80.683,82.327c0,0,1.883-1.999,4.705-4.998c1.412-1.5,3.057-3.252,4.837-5.109
            ...
            <g id="secondhand">
                <path
                    fill="#0D1121"
                    d="M109.393,136.162c0,0-1.853-3.493-4.63-8.73c-1.385-2.62-2.999-5.678-4.73-8.954
                ...
                <path
                    fill="#0D1121"
                    d="M106.965,131.248c0,0-0.026,0.013-0.072,0.03c-0.051,0.019-0.115,0.059-0.215,0.075
